...
{
    /// <inheritdoc />
    public partial class VirtualLookup : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Equipment = table.Column<Guid>(type: "uuid", nullable: false),
                    Count = table.Column<int>(type: "integer", nullable: false),
                    UnitFactor = table.Column<int>(type: "integer", nullable: false),
                    HourlyRental = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Labour = table.Column<Guid>(type: "uuid", nullable: false),
                    Count = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TypeOfMaterial = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScheduleId = table.Column<Guid>(type: "uuid", nullable: false),
                    ManPowerCostId = table.Column<Guid>(type: "uuid", nullable: false),
                    EquipmentCostId = table.Column<Guid>(type: "uuid", nullable: false),
                    MaterialCostId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    DeletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DailyReports_Users_ApprovedByUserId",
                        column: x => x.ApprovedByUserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_DailyReports_Users_CreatedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DailyReports_ApprovedByUserId",
                table: "DailyReports",
                column: "ApprovedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_DailyReports_CreatedByUserId",
                table: "DailyReports",
